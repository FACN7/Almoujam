...
// var data = ['isreal','london','cairo'];// fetch(Request..then().catch();
/*initiate the autocomplete function on the "myInput" element, and pass along the countries array as possible autocomplete values:*/
// fetch("/getcountries").then(response=> response.json()).then( JSONdata=>{data = JSONdata.data;} ).catch(err=>{console.log("failed to retrive data");});
